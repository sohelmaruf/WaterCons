...
define(['application-configuration', 'adminService', 'alertsService'], function (app) {
  ...
  app.register.controller('myAccountController', ['$scope', '$rootScope', 'adminService', 'alertsService',
    function ($scope, $rootScope, adminService, alertsService) {
            ...
            $scope.updateUser = function () {
                ...
                adminService.updateUser(user, $scope.updateUserCompleted, $scope.updateUserError);
            }
