...
define(['angularAMD', 'angular-route', 'ui-bootstrap', 'angular-sanitize', 'blockUI', ], function (angularAMD) {
    ...
    var indexController = function ($scope, $rootScope, $http, $location, blockUI) {
        ...
        $scope.initializeIndex = function (successFunction, errorFunction) {
        };
    ...
    var applicationController = function ($scope, $rootScope, $http, $location, blockUI) {
    ...
    applicationController.$inject = ['$scope', '$rootScope', '$http', '$location', 'blockUI'];
